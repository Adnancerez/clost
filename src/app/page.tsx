...
export default async function HomePage() {
  ...
  return (
    <main className="flex-grow pt-16 flex flex-col">
      ...
      <section className="relative w-full h-[75vh] md:h-[870px] border-b border-primary overflow-hidden group select-none">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-10 pb-12 md:pb-20 z-10 pointer-events-none">
          <div className="pointer-events-auto mb-2">
            <span className="font-label-mono text-xs uppercase bg-primary text-white px-3 py-1 tracking-widest inline-block">
              YENİ DROP // FALL 2024
            </span>
          </div>
          ...
          <div className="pointer-events-auto flex flex-wrap gap-3">
            <Link
              ...
              className="inline-block bg-primary text-on-primary font-label-mono text-sm px-10 py-4 hover:bg-surface hover:text-primary border border-transparent hover:border-primary transition-colors duration-300 uppercase tracking-widest font-bold"
            >
              Tüm Parçaları Keşfet →
            </Link>
            <Link
              href="/lookbook"
              className="inline-block bg-surface text-primary font-label-mono text-sm px-8 py-4 hover:bg-primary hover:text-white border border-primary transition-colors duration-300 uppercase tracking-widest font-bold"
            >
              Lookbook &apos;24
            </Link>
          </div>
      ...
      <section className="py-12 md:py-20 border-b border-primary bg-surface" id="featured">
      ...
      <section id="manifesto" className="border-b border-primary bg-surface-bright">
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px] lg:min-h-[716px]">
          ...
          <div className="lg:col-span-4 lg:col-start-9 flex flex-col justify-center p-6 md:p-10 py-16">
            <span className="font-label-mono uppercase text-on-surface-variant mb-4 border-b border-outline-variant pb-1 inline-block w-max text-xs font-bold">
              EDİTORYAL 001 // Y2K ESTETİĞİ
            </span>
            <h2 className="font-headline-md uppercase text-primary mb-4 tracking-tighter leading-none font-bold">
              Kuralsız
              <br />
              Sokak Dili
            </h2>
            ...
            <Link
              href="/collections/all"
              className="inline-block border border-primary text-primary font-label-mono text-xs px-10 py-4 text-center hover:bg-primary hover:text-on-primary transition-colors duration-300 uppercase tracking-widest w-full sm:w-auto font-bold"
            >
              Koleksiyonu İncele
            </Link>
          </div>
