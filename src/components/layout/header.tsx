...
export function Header() {
  ...
  return (
    <>
      <header className="fixed top-8 left-0 right-0 w-full z-40 flex justify-between items-center px-4 md:px-8 h-14 bg-surface border-b border-primary transition-all duration-200 select-none">
        {/* Desktop Nav Links */}
        ...
        <Link
          href="/"
          className="font-headline-sm text-lg md:text-xl font-black tracking-tighter text-primary uppercase absolute left-1/2 -translate-x-1/2 cursor-pointer hover:opacity-90 transition-opacity"
        >
          CLOST
        </Link>
